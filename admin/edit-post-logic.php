...
if(isset($_POST['submit'])){
    ...
    if(!$title){
        ...
        // delete existsing thumbnail if new thumbnail is available
        if($thumbnail['name']){
            ...
            $allowed_files=['pnj','jpg','jpeg','heic'];
            ...
            if(in_array($extension,$allowed_files)){
                ...
                if($thumbnail['size']<2000000){
                    ...
                    $_SESSION['edit-post']="Couldn't Update Post. Thumbnail should be less than 2mb";
                }
            } else{
                $_SESSION['edit-post']="Couldn't Update Post. Thumbnail should be png, jpeg, jpg, or heic";
            }
        }
    }
