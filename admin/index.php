...
//fetch current users's posts from database
                ...
                <table>
                    ...
                    <tbody>
                        <?php while($post=mysqli_fetch_assoc($posts)) : ?>
                            <?php 
                                //get category of each post from category table
                                $category_id=$post['category_id'];
                                $category_query="SELECT title FROM categories WHERE id=$category_id";
                                $categoty_result=mysqli_query($connection,$category_query);
                                $category=mysqli_fetch_assoc($categoty_result);
                            ?>
                            <tr>
                                <td><?= $post['title']?></td>
